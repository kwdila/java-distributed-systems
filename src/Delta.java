...
public class Delta {
    ...
    public static void main(String[] args) {
        System.out.println("Delta worker started on port " + PORT);
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    if (message.getWord().equals("COLLECT")) {
                        ...
                        System.out.println("Delta received: " + message.getWord() + " with clock: " + lamportClock);
            ...
            System.err.println("Failed to start Delta worker on port " + PORT + ": " + e.getMessage());
        }
    }
}