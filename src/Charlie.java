...
public class Charlie {
    ...
    public static void main(String[] args) {
        System.out.println("Charlie worker started on port " + PORT);
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    if (message.getWord().equals("COLLECT")) {
                        ...
                        System.out.println("Charlie received: " + message.getWord() + " with clock: " + lamportClock);
            ...
            System.err.println("Failed to start Charlie worker on port " + PORT + ": " + e.getMessage());
        }
    }
}